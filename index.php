	...
	?>
		...
		<!-- Banner -->
			<section id="banner" class="wrapper">
				<div class="container">
				<h2>AgriSmart</h2>
				<p>Bringing the future of farming to your fingertips!</p>
				<br><br>
				<center>
		...
		<div class="footer-left">
			<h3 style="font-family: 'Times New Roman', cursive;">AgriSmart &copy; </h3>
		<!--	<div class="logo">
				<a href="index.php"><img src="images/logo.png" width="200px"></a>
			</div>-->
			<br />
			<p style="font-size:20px;color:white">Bringing the future of farming to your fingertips!</p>
			<br />
		</div>
		...
		<div class="footer-center">
			<div>
				...
				<p style="font-size:20px">AgriSmart Farm<span>chennai</span></p>
			</div>
			<div>
			...
			<div>
				...
				<p style="font-size:20px"><a href="mailto:agroculture@gmail.com" style="color:white">AgriSmart@gmail.com</a></p>
			</div>
		</div>

		<div class="footer-right">
			<p class="footer-company-about" style="color:white">
				<span style="font-size:20px"><b>About AgriSmart</b></span>
				AgriSmart is e-commerce trading platform for grains & grocerries...
			</p>
